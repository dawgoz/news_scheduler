...
MAX_ARTICLES_PER_TOPIC_MORNING = int(os.getenv("MAX_ARTICLES_PER_TOPIC_MORNING", "10"))
MAX_ARTICLES_PER_TOPIC_MIDDAY = int(os.getenv("MAX_ARTICLES_PER_TOPIC_MIDDAY", "10"))
MAX_ARTICLES_PER_TOPIC_EVENING = int(os.getenv("MAX_ARTICLES_PER_TOPIC_EVENING", "10"))
